...
sacola = Button(frame1, image=carrinho, background='Black', relief='flat', cursor='hand2', bd=0,
                activebackground='Black', activeforeground='White', command=lambda: pagamento())
...
Login = Button(frame1, text='Login', background='Black', foreground='White', cursor='hand2', relief='flat', bd=0,
               activebackground='Black', activeforeground='White', command=lambda: login())
...
Cadastro = Button(frame1, text='Cadastro', background='Black', foreground='White', cursor='hand2', relief='flat', bd=0,
                  activebackground='Black', activeforeground='White', command=lambda: cadastro())
...
def paginaInicial():
    ...
    camisas = Button(frame2, text='Camisas', background='Black', foreground='White', cursor='hand2', relief='flat',
                     bd=0, activebackground='Black', activeforeground='White', command=lambda: modelo_camisa())
    ...
    moletom = Button(frame2, text='Moletons', background='Black', foreground='White', cursor='hand2', relief='flat',
                     bd=0, activebackground='Black', activeforeground='White', command=lambda: modelo_moletom())
    ...
    canecas = Button(frame2, text='Canecas', background='Black', foreground='White', cursor='hand2', relief='flat',
                     bd=0, activebackground='Black', activeforeground='White', command=lambda: modelo_caneca())
    ...
    img1_camisa = Button(frame2, image=camisa_pagina_inicial, background='Black', cursor='hand2', relief='flat', bd=0,
                         activebackground='Black', activeforeground='White', command=lambda: modelo_camisa())
    img1_camisa.place(relx=0.07, rely=0.4)
    button1 = Button(frame2, image=abc, background='Black', foreground='White', relief='flat', bd=0,
                     activebackground='Black', cursor='hand2', activeforeground='White',
                     command=lambda: modelo_camisa())
    ...
    moletom.configure(font=(fontE))
    img1_moletom = Button(frame2, image=moletom_pagina_inicial, background='Black', cursor='hand2', relief='flat', bd=0,
                          activebackground='Black', activeforeground='White', command=lambda: modelo_moletom())
    img1_moletom.place(relx=0.42, rely=0.34)
    button2 = Button(frame2, image=abc, background='Black', foreground='White', relief='flat', bd=0,
                     activebackground='Black', cursor='hand2', activeforeground='White',
                     command=lambda: modelo_moletom())
    ...
    img1_caneca = Button(frame2, image=caneca_pagina_inicial, background='Black', cursor='hand2', relief='flat', bd=0,
                         activebackground='Black', activeforeground='White', command=lambda: modelo_caneca())
    img1_caneca.place(relx=0.75, rely=0.35)
    button3 = Button(frame2, image=abc, background='Black', foreground='White', relief='flat', bd=0,
                     activebackground='Black', cursor='hand2', activeforeground='White',
                     command=lambda: modelo_caneca())
    button3.place(relx=0.92, rely=0.47)
    button3.configure(font=('italic', 30))


# Frame3
direitosAutorais = Label(frame3, text='© 2022 CompuStore® | Todos direitos reservados', background='Black',
                         foreground='White')
...
def modelo_camisa():
    ...
    camisa1 = Button(frame2, image=camiseta_modelo1, background='Black', relief='flat', bd=0, activebackground='Black',
                     activeforeground='White', command=lambda: [zerar_quantidade(), comprar_camisa('Camisa1')])
    camisa1.place(relx=0.05, rely=0.35)

    camisa2 = Button(frame2, image=camiseta_modelo2, background='Black', relief='flat', bd=0, activebackground='Black',
                     activeforeground='White', command=lambda: [zerar_quantidade(), comprar_camisa('Camisa2')])
    camisa2.place(relx=0.25, rely=0.35)

    camisa3 = Button(frame2, image=camiseta_modelo3, background='Black', relief='flat', bd=0, activebackground='Black',
                     activeforeground='White', command=lambda: [zerar_quantidade(), comprar_camisa('Camisa3')])
    camisa3.place(relx=0.45, rely=0.35)

    camisa4 = Button(frame2, image=camiseta_modelo4, background='Black', relief='flat', bd=0, activebackground='Black',
                     activeforeground='White', command=lambda: [zerar_quantidade(), comprar_camisa('Camisa4')])
    camisa4.place(relx=0.65, rely=0.35)

    camisa5 = Button(frame2, image=camiseta_modelo5, background='Black', relief='flat', bd=0, activebackground='Black',
                     activeforeground='White', command=lambda: [zerar_quantidade(), comprar_camisa('Camisa5')])
...
def modelo_moletom():
    ...
    moletom1 = Button(frame2, image=moletom_modelo1, background='Black', bd=0, activebackground='Black',
                      activeforeground='White', command=lambda: [zerar_quantidade(), comprar_moletom('Moletom1')])
    moletom1.place(relx=0.03, rely=0.35)

    moletom2 = Button(frame2, image=moletom_modelo2, background='Black', bd=0, activebackground='Black',
                      activeforeground='White', command=lambda: [zerar_quantidade(), comprar_moletom('Moletom2')])
    moletom2.place(relx=0.23, rely=0.35)

    moletom3 = Button(frame2, image=moletom_modelo3, background='Black', bd=0, activebackground='Black',
                      activeforeground='White', command=lambda: [zerar_quantidade(), comprar_moletom('Moletom3')])
    moletom3.place(relx=0.43, rely=0.35)

    moletom4 = Button(frame2, image=moletom_modelo4, background='Black', bd=0, activebackground='Black',
                      activeforeground='White', command=lambda: [zerar_quantidade(), comprar_moletom('Moletom4')])
    moletom4.place(relx=0.63, rely=0.35)

    moletom5 = Button(frame2, image=moletom_modelo5, background='Black', bd=0, activebackground='Black',
                      activeforeground='White', command=lambda: [zerar_quantidade(), comprar_moletom('Moletom5')])
...
def modelo_caneca():
    ...
    caneca1 = Button(frame2, image=caneca_modelo1, background='Black', bd=0, activebackground='Black',
                     activeforeground='White', command=lambda: [zerar_quantidade(), comprar_caneca('Caneca1')])
    caneca1.place(relx=0.05, rely=0.35)
    # 0.05 0.35
    caneca2 = Button(frame2, image=caneca_modelo2, background='Black', bd=0, activebackground='Black',
                     activeforeground='White', command=lambda: [zerar_quantidade(), comprar_caneca('Caneca2')])
    caneca2.place(relx=0.25, rely=0.35)
    # 0.25 0.35
    caneca3 = Button(frame2, image=caneca_modelo3, background='Black', bd=0, activebackground='Black',
                     activeforeground='White', command=lambda: [zerar_quantidade(), comprar_caneca('Caneca3')])
    caneca3.place(relx=0.45, rely=0.35)
    # 0.45 0.35
    caneca4 = Button(frame2, image=caneca_modelo4, background='Black', bd=0, activebackground='Black',
                     activeforeground='White', command=lambda: [zerar_quantidade(), comprar_caneca('Caneca4')])
    caneca4.place(relx=0.65, rely=0.35)
    # 0.65 0.35
    caneca5 = Button(frame2, image=caneca_modelo5, background='Black', bd=0, activebackground='Black',
                     activeforeground='White', command=lambda: [zerar_quantidade(), comprar_caneca('Caneca5')])
...
def comprar_camisa(modelo):
    ...
    cor1 = Button(frame2, image=cor_preto, background='Black', foreground='White', bd=0, activebackground='Black',
                  activeforeground='White', command=lambda: trocar_cor_roupa(modelo, 'Preto'))
    cor1.place(relx=0.35, rely=0.45)
    cor2 = Button(frame2, image=cor_branca, background='Black', foreground='White', bd=0, activebackground='Black',
                  activeforeground='White', command=lambda: trocar_cor_roupa(modelo, 'Branco'))
    cor2.place(relx=0.4, rely=0.45)
    cor3 = Button(frame2, image=cor_cinza, background='Black', foreground='White', bd=0, activebackground='Black',
                  activeforeground='White', command=lambda: trocar_cor_roupa(modelo, 'Cinza'))
    ...
    diminuir_quantidade = Button(frame2, text='-', background='Black', foreground='White', relief='flat', bd=0,
                                 activebackground='Black', activeforeground='White', command=lambda: diminuir())
    diminuir_quantidade.place(relx=0.35, rely=0.6)
    aumentar_quantidade = Button(frame2, text='+', background='Black', foreground='White', relief='flat', bd=0,
                                 activebackground='Black', activeforeground='White', command=lambda: aumentar())
    ...
    aumentar_tamanho = Button(frame2, text='+', background='Black', foreground='White', relief='flat', bd=0,
                              activebackground='Black', activeforeground='White',
                              command=lambda: aumentar_tamanho_roupa())
    aumentar_tamanho.place(relx=0.9, rely=0.5)
    diminuir_tamanho = Button(frame2, text='-', background='Black', foreground='White', relief='flat', bd=0,
                              activebackground='Black', activeforeground='White',
                              command=lambda: diminuir_tamanho_roupa())
    ...
    frete_button = Button(text='Calcular', background='Black', foreground='White', relief='flat', bd=0,
                          activebackground='Black', activeforeground='White', )
    frete_button.place(relx=0.8, rely=0.8)

    comprar = Button(text='Comprar', background='#FF34D8', foreground='White', bd=0, activebackground='#FF34D8',
                     activeforeground='White', command=lambda: [adicionar_item_carrinho('Roupa'), endereco()])
...
def comprar_caneca(modelo):
    ...
    frete_button = Button(text='Calcular', background='Black', foreground='White', relief='flat',
                          command=lambda: deslogar())
    frete_button.place(relx=0.35, rely=0.7)

    quantidade = Label(frame2, text='Quantidade', background='Black', foreground='White')
    quantidade.place(relx=0.75, rely=0.55)
    diminuir_quantidade = Button(frame2, text='-', background='Black', foreground='White', bd=0,
                                 activebackground='Black', activeforeground='White', command=lambda: diminuir())
    diminuir_quantidade.place(relx=0.75, rely=0.6)
    aumentar_quantidade = Button(frame2, text='+', background='Black', foreground='White', bd=0,
                                 activebackground='Black', activeforeground='White', command=lambda: aumentar())
    ...
    comprar = Button(text='Comprar', background='#FF34D8', foreground='White', bd=0, activebackground='#FF34D8',
                     activeforeground='White', command=lambda: [adicionar_item_carrinho('Caneca'), pagamento()])
...
def login():
    ...
    login = Button(frame2, text='Login', background='Black', foreground='White', relief='flat', bd=0,
                   activebackground='Black', activeforeground='White',
                   command=lambda: isLoged(email.get(), password.get()))
    ...
    op = Button(frame2, text='Cadastre-se aqui', background='Black', foreground='White', relief='flat', bd=0,
                activebackground='Black', activeforeground='White', )
...
def cadastro():
    ...
    cadastro = Button(text='Cadastrar', background='Black', foreground='White', relief='flat', bd=0,
                      activebackground='Black', activeforeground='White',
                      command=lambda: dados(password.get(), confPassword.get(), email.get(), cpf.get(),
                                            nome_completo.get(), data_nascimento.get()))
...
def menu_logado():
    if logado == True:
        ...
        sacola = Button(frame1, image=carrinho, background='Black', relief='flat', cursor='hand2', bd=0,
                        activebackground='Black', activeforeground='White', command=lambda: pagamento())
        sacola.place(relx=0.87, rely=0.35)
        initial_page = Button(frame1, image=logo_sem_nome, relief='flat', cursor='hand2', bd=0,
                              command=lambda: paginaInicial())
        initial_page.place(relx=0.053, rely=0.1, relwidth=0.06, relheight=0.5)
        logq = Label(frame1, image=log, background='Black')
        logq.place(relx=0.8, rely=0.35)
        botao_sair = Button(frame1, text='Sair', background='Black', foreground='White', relief='flat', cursor='hand2',
                            bd=0, activebackground='Black', activeforeground='White', command=lambda: deslogar())
        ...
        Login = Button(frame1, text='Login', background='Black', foreground='White', cursor='hand2', relief='flat',
                       bd=0, activebackground='Black', activeforeground='White', command=lambda: login())
        Login.place(relx=0.75, rely=0.4, relwidth=0.04, relheight=0.2)
        separar = Label(frame1, text='|', background='Black', foreground='White')
        separar.place(relx=0.791, rely=0.38)
        separar.configure(font=(fontSeparador))
        Login.configure(font=('Arial', 15))
        Cadastro = Button(frame1, text='Cadastro', background='Black', foreground='White', cursor='hand2',
                          relief='flat', bd=0, activebackground='Black', activeforeground='White',
...
def pagamento():
    ...
    pix_selecionar = Button(frame2, image=botao_pagamento, background='Black', foreground='White', relief='flat', bd=0,
                            activebackground='Black', activeforeground='White', command=lambda: pagamento_pix())
    ...
    boleto_selecionar = Button(frame2, image=botao_pagamento, background='Black', foreground='White', relief='flat',
                               bd=0, activebackground='Black', activeforeground='White',
                               command=lambda: pagamento_boleto())
    ...
    cartao_selecionar = Button(frame2, image=botao_pagamento, background='Black', foreground='White', relief='flat',
                               bd=0, activebackground='Black', activeforeground='White',
                               command=lambda: pagamento_cartao())
...
def pagamento_pix():
    ...
    camisas = Button(frame2, text='Camisas', background='Black', foreground='White', cursor='hand2', bd=0,
                     activebackground='Black', activeforeground='White', relief='flat', command=lambda: modelo_camisa())
    camisas.place(relx=0.345, rely=0.01, relwidth=0.085, relheight=0.08)

    moletom = Button(frame2, text='Moletons', background='Black', foreground='White', cursor='hand2', bd=0,
                     activebackground='Black', activeforeground='White', relief='flat',
                     command=lambda: modelo_moletom())
    moletom.place(relx=0.452, rely=0.01, relwidth=0.085, relheight=0.08)

    canecas = Button(frame2, text='Canecas', background='Black', foreground='White', cursor='hand2', bd=0,
                     activebackground='Black', activeforeground='White', relief='flat', command=lambda: modelo_caneca())
    canecas.place(relx=0.561, rely=0.01, relwidth=0.085, relheight=0.08)
    ...
    pix = Label(frame2, text='Pix', background='Black', foreground='White')
    pix.place(relx=0.15, rely=0.3)
    pix_selecionar = Button(frame2, image=botao_pagamento_selecionado, background='Black', foreground='White',
                            relief='flat', bd=0, activebackground='Black', activeforeground='White', )
    pix_selecionar.place(relx=0.1, rely=0.3)
    ...
    termos_de_uso = Button(frame2, image=botao1_pagamento, background='Black', foreground='White', relief='flat', bd=0,
                           activebackground='Black', activeforeground='White')
    ...
    finalizar = Button(frame2, text='Finalizar pedido', background='Black', foreground='White', relief='flat', bd=0,
                       activebackground='Black', activeforeground='White')
...
def pagamento_boleto():
    ...
    boleto = Label(frame2, text='Boleto', background='Black', foreground='White')
    boleto.place(relx=0.15, rely=0.4)
    boleto_selecionar = Button(frame2, image=botao_pagamento_selecionado, background='Black', foreground='White', bd=0,
                               activebackground='Black', activeforeground='White', relief='flat')
    boleto_selecionar.place(relx=0.1, rely=0.4)
    ...
    finalizar = Button(frame2, text='Finalizar pedido', background='Black', foreground='White', relief='flat', bd=0,
                       activebackground='Black', activeforeground='White',
                       command=lambda: verificar_dados_boleto(nome_entrada.get(), sobrenome_entrada.get(),
                                                              documento_entrada.get()))
    finalizar.place(relx=0.75, rely=0.85)
...
def pagamento_cartao():
    ...
    pix = Label(frame2, text='Pix', background='Black', foreground='White')
    pix.place(relx=0.15, rely=0.3)
    pix_selecionar = Button(frame2, image=botao_pagamento, background='Black', foreground='White', relief='flat',
                            command=lambda: pagamento_pix())
    pix_selecionar.place(relx=0.1, rely=0.3)
    ...
    cartao = Label(frame2, text='Cartão Débito/Crédito', background='Black', foreground='White')
    cartao.place(relx=0.15, rely=0.5)
    cartao_selecionar = Button(frame2, image=botao_pagamento_selecionado, background='Black', foreground='White',
                               relief='flat')
    cartao_selecionar.place(relx=0.1, rely=0.5)
    ...
    diminuir_quantidade = Button(frame2, text='-', background='Black', foreground='White', relief='flat', bd=0,
                                 activebackground='Black', activeforeground='White',
                                 command=lambda: diminuir_parcelas())
    diminuir_quantidade.place(relx=0.6, rely=0.75)
    aumentar_quantidade = Button(frame2, text='+', background='Black', foreground='White', relief='flat', bd=0,
                                 activebackground='Black', activeforeground='White',
                                 command=lambda: aumentar_parcelas())
    ...
    finalizar = Button(frame2, text='Finalizar pedido', background='Black', foreground='White', relief='flat', bd=0,
                       activebackground='Black', activeforeground='White',
                       command=lambda: verificar_dados_cartao(numero_cartao_entrada.get(), nome_entrada.get(),
                                                              vencimento_entrada.get(), codigo_entrada.get(),
                                                              cpf_entrada.get()))
