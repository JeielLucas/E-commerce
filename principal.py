...
janela.minsize(1500, 750)
janela.maxsize(1500, 750)
...
'''logo = Label(frame1, text='COMPU', background='Black', foreground='White')
logo.configure(font=('Arial', 30))
logo.place(relx=0.17, rely=0.35, relwidth=0.1, relheight=0.3)
logo2 = Label(frame1, text='S T O R E', background='Black', foreground='#DD38B8')#
logo2.configure(font=('Arial', 30))
logo2.place(relx=0.29, rely= 0.35, relwidth=0.12, relheight=0.3)'''

login = Button(frame1, text='Login', background='Black', foreground='White', relief='flat', command= lambda:[frame2.destroy(), login2(janela)])
...
cadastro = Button(frame1, text='Cadastro', background='Black', foreground='White', relief='flat')
...
camisas = Button(frame2, text='Camisas', background='Black', foreground='White', relief='flat')
moletom = Button(frame2, text='Moletons', background='Black', foreground='White', relief='flat')
canecas = Button(frame2, text='Canecas', background='Black', foreground='White', relief='flat')
