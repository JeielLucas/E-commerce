...
camisas = Button(frame2, text='Camisas', background='Black', foreground='White', cursor='hand2', relief='flat', command=lambda: pagamento(janela))
...
canecas = Button(frame2, text='Canecas', background='Black', foreground='White', cursor='hand2', relief='flat', command=lambda: cartao(janela))
...
button1 = Button(frame2, text='>', background='Black', foreground='White', relief='flat', command=lambda: endereco(janela))
